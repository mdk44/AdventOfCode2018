...
input_file = 'Day 16\\Day 16 Test 2.txt'
...
addr = effect(lambda before,x,y: before[x]+before[y])
addi = effect(lambda before,x,y: before[x]+y)
mulr = effect(lambda before,x,y: before[x]*before[y])
